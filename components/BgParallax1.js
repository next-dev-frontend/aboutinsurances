  ...
  return (
    <div>
      <section className="relative bg-center flex items-center justify-center bg-fixed bg-cover bg-no-repeat w-screen h-96 md:h-max">
        <div className="absolute w-full h-full top-0 left-0 bg-cover bg-center bg-no-repeat bg-fixed" style={{ backgroundImage: 'url(/backgrounds/bg1-insurances.webp)', alt: 'Background Image' }} />
