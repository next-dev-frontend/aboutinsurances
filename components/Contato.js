        ...
        <div className="select-none container max-w-5xl mx-auto w-full bg-opacity-0 rounded text-light-green">
            <div className="grid grid-cols-2">
                    ...
                    <div className="bg-opacity-0 mx-auto max-w-xl flex flex-col space-y-5">
                        ...
                        <div className="flex justify-center md:justify-start">
                            <ul className="flex gap-4 md:gap-6">
                                ...
                                <li>
                                    <a href="#home" title="Instagram da ConsultBio Jr." rel="noopener noreferrer" target="_self" className="text-color1 transition hover:text-color2">
                                ...
                                <li>
                                    <a href="#home" title="Twitter da ConsultBio Jr." rel="noopener noreferrer" target="_self" className="text-color1 transition hover:text-color2">
                ...
                <div className="order-2 col-span-full md:col-span-1 py-5 md:py-10 px-6">
                    <form className="bg-opacity-0 rounded mx-auto max-w-xl space-y-4" onSubmit={handleSubmit}>
