...
const SobreCeleste = () => {
    return (
        <div id="sobreceleste" className="select-none container w-full max-w-5xl mx-auto pt-20 pb-10">
                ...
                <div className="w-auto px-8">
                    <div className="mx-auto align-middle">
                        <h2 data-anime="left" className="text-center text-2xl md:text-3xl lg:text-4xl pt-10 text-dark-green mx-auto font-bold leading-none mb-3 pb-8">
                            Conheça a nossa mascote:
                        </h2>

                        <div data-anime="up" className="relative">
                            <div className="animate-bounce float-left w-28 md:w-32 lg:w-44 h-full pr-4 pt-8">
                                <Image
                                    src={logoCeleste}
                                    alt="Logotipo Celeste da ConsultBio Jr."
                                    layout="intrinsic"
                                    objectFit='cover'
                                    quality={100}
                                />
