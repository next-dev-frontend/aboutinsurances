...
const ContentSecurityPolicy = `
  ...
  style-src 'self' 'unsafe-hashes' data: https://aboutinsurances.vercel.app/ https://*.googletagmanager.com https://*.tagmanager.google.com https://*.google-analytics.com 'nonce-${nonce}';
