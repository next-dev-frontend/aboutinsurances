...
const ContentSecurityPolicy = `
  default-src 'self';
  script-src 'self' https://www.googletagmanager.com https://www.google-analytics.com 'strict-dynamic' 'sha256-${gaHash}' 'sha256-${gtmHash}' 'nonce-${gtmNonce}';
  script-src-elem 'self' https://www.googletagmanager.com https://www.google-analytics.com 'sha256-${gaHash}' 'sha256-${gtmHash}' 'nonce-${gtmNonce}';
