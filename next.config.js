...
const ContentSecurityPolicy = `
  ...
  style-src 'self' 'unsafe-inline' 'nonce-${nonce}' https://aboutinsurances.vercel.app 'strict-dynamic' https://*.googletagmanager.com https://*.tagmanager.google.com https://*.google-analytics.com;
