...
const ContentSecurityPolicy = `
  ...
  script-src-elem 'self' 'nonce-${nonce}' 'sha256-${selfScriptHash}' 'sha256-${gtmScriptHash}' 'sha256-${gtagScriptHash}' 'strict-dynamic' https://www.googletagmanager.com https://www.googletagmanager.com/gtag/js?id=GTM-MWPBQXC https://aboutinsurances.vercel.app 'unsafe-inline';
