...
const ContentSecurityPolicy = `
  default-src 'self';
  script-src 'self' https://www.googletagmanager.com/gtag/ 'nonce-${nonce}' 'sha256-${gtmScriptHash}' 'strict-dynamic' 'unsafe-inline';
  script-src-elem 'self' https://www.googletagmanager.com/gtag/ 'nonce-${nonce}' 'sha256-${gtmScriptHash}' 'strict-dynamic';
