...
export default function page404() {
  return (
    ...
    <section id="page400" className="relative flex flex-wrap flex-shrink md:flex-shrink-0 items-center justify-center m-auto bg-no-repeat w-full max-w-full h-screen">
      <Image
      ...
      <div className="absolute grid h-screen place-content-center bg-opacity-0">
        <div className="text-center">
          ...
          <h1 className="mt-4 text-gray-500 pb-8">Page not found.</h1>
